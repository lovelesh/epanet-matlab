...
%         MsxComputedQualityLink;
        ...
        OptionsHydraulics; %Save or Use hydraulic solution. *** Not implemented ***
    ...
    methods
        function obj   = epanet(pathfile,varargin)
            ...
            %Open the file
            obj.LoadInpFile([pwd,'/NETWORKS/',inpfile], 'temp1.$$$', 'temp2.$$$');
            %Set path of temporary file
            obj.pathfile='temp.inp';
            %Save the temporary input file
            obj.saveInputFile(obj.pathfile);
            %Close input file
            ENclose;
            %Load temporary file
            obj.LoadInpFile(obj.pathfile,'temp.txt','temp.out');
...
%Set path of temporary file
obj.pathfileMsx=[pwd,'/RESULTS/temp.msx'];
